...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
     * | LATL   | LGUI   | (NUM)  | (FN)   |       SPC       | LEFT   | DOWN   | RIGHT  | CAP    | MUTE   | MIC    | WIN    | RCTL   |
     * '-----------------------------------------------------------------------------------------------------------------------------'
     */

    [_ALPHAS] = LAYOUT_hobbes(\
        ...
        KC_LALT,  KC_LGUI, LT(_NUM, KC_NO), OSL(_FNC), KC_SPC,        KC_LEFT, KC_DOWN, KC_RGHT,  LALT(KC_Z), KC_MUTE, KC_M,   KC_RGUI, KC_RCTL \
    ),
